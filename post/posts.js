        ...
        if(resultPosts == ""){
            ...
            if(filterArg <= 10){
                for(let i = 0; i < homeFilter.length; i++){
                    const newElement = `
                        <button class="accHeader d-flex justify-content-between align-items-center"><span class="userName fw-bold">${homeFilter[i].userId}</span><i class="fa-solid fa-plus fa-xl menu-plus"></i></button>
